...
transaction = contract.functions.claim(nonce).buildTransaction({
    'from': 0xAe693a9b03B2Ef5F642f82d910e19D7b47Bb87B7,
    'gas': 2000,
...
signed_txn = w3.eth.account.sign_transaction(transaction, private_key=0xfb91cee50e8cbcbb250f17a85ca66b0f8b915cf27764aeccce611915ae022caf)
